...
city = "Texas"  # Change this to "Texas" when needed
...
def submit_export_job():
    ...
    params = {
        ...
        "dow": [0, 1, 2, 3, 4, 5, 6],
        "dsFields": [{"id": selected_data_source, "columns": all_columns}], # Here TMC is the unique identifier for the TMC HOUSTON USES INRIX
    ...
    print(f' \n \n We are in {city} so we are using {selected_data_source} \n \n')
